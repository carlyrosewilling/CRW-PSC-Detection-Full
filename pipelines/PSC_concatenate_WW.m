...
[filename,pathname,~] = uigetfile({'*.xlsx', '*xls*'}, 'Select Excel file with accepted traces');
[~, ~, aPSCTableRaw] = xlsread(fullfile(pathname, filename));
...
filename2 = 'Cell Summary-WT.xlsx';
pathname2 = '/Volumes/Neurobio/MICROSCOPE/Kevin/3-Experiments/4-SliceEphys/6-WT Normal Development/2-Output/';
